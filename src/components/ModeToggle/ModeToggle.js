...
function ModeToggle() {
    ...
    return (
        <div className='light-dark-toggle' onClick={() => {
            if(lightModeState === 'light-mode-visible' && darkModeState === 'dark-mode-invisible') {
                setLightModeState('light-mode-invisible')
                setDarkModeState('dark-mode-visible')
            }
            else if (lightModeState === 'light-mode-invisible' && darkModeState === 'dark-mode-visible') {
